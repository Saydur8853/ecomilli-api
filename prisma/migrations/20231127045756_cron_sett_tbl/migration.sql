/*
  ...
  - You are about to alter the column `schedule` on the `cron_settings` table. The data in that column could be lost. The data in that column will be cast from `VarChar(150)` to `Json`.
...
-- AlterTable
ALTER TABLE `cron_settings` MODIFY `schedule` JSON NOT NULL;
